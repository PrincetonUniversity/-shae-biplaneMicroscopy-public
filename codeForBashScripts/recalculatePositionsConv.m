function []=recalculatePositionsConv(files2Fix,trajOrProb,iiFile)
...
saveFileGrainRot = fullfile(strcat(Ivars.saveFileNameTraj,num2str(Ivars.iiCell),'_fixedZFull','.csv'))
