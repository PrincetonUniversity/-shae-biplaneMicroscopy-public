function [p]=plotMSDlinear2Dcorr(strucIn,sizeT,color,sigmaxy,lineChar)
...
rowMeanFull=strucIn.rowMeanX+strucIn.rowMeanY-sigmaxy;
...
intervalsX=strucIn.intervalsX-sigmaxy;
